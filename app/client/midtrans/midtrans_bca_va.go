...
func NewBcaVa(midtrans *Midtrans) *BcaVa {
	return &BcaVa{
		midtrans: midtrans,
	}
}

func (b *BcaVa) Pay(ctx context.Context, req any) (map[string]interface{}, error) {
...
func (b *BcaVa) ClientResponse(channel *models.Channel, payment *models.Payments) (*web.PaymentResponse, error) {
	var bcaVaResponse BCAVAResponse

	err := json.Unmarshal(payment.GatewayResponse, &bcaVaResponse)
	if err != nil {
		return nil, err
	}

	if bcaVaResponse.StatusCode != "201" {
		return nil, helpers.NewErrorTrace(fmt.Errorf(bcaVaResponse.StatusMessage), b.midtrans.serviceName).WithStatusCode(http.StatusPaymentRequired)
	}
	...
	return &web.PaymentResponse{
		...
		PaymentDetail: web.PaymentDetail{
			Bank:            enums.Channel(bcaVaResponse.VaNumbers[0].Bank),
			Url:             nil,
			VaNumber:        bcaVaResponse.VaNumbers[0].VaNumber,
			TransactionTime: bcaVaResponse.TransactionTime,
			ExpireTime:      bcaVaResponse.ExpiryTime,
...
func (b *BcaVa) createChargeRequest(req PaymentRequest) map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"bank_transfer": map[string]interface{}{
			"bank": "bca",
			//"va_number": "111111",
			//"free_text": map[string]interface{}{
...
// BCA VA JSON Request Format
/*
JSON Attribute       | Description                                                       | Type   | Required
---------------------|-------------------------------------------------------------------|--------|---------
payment_type         | Set Bank Transfer payment method. Value: bank_transfer           | String | Required
transaction_details  | The details of the transaction such as order_id and gross_amount | Object | Required
