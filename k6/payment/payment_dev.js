...
const paymentSchenarioJson = JSON.parse(open("payment_scenario_dev.json"));
...
export default function (data) {
  ...
  //   }
  // );
  // const checkPayment = check(checkPaymentResponse, {
  //   "is status check payment 200": (r) => r.status === 200,
  // });
  // if (!checkPayment) {
  //   fail("check payment failed", checkPaymentResponse.body);
  // }
